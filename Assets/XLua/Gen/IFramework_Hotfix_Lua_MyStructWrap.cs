...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixLuaMyStructWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Lua.MyStruct);
        ...
        static int _g_get_a(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Lua.MyStruct gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _g_get_e(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Lua.MyStruct gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushIFrameworkHotfixLuaPedding(L, gen_to_be_invoked.e);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_a(RealStatePtr L)
        {
		    try {
                ...
                translator.UpdateIFrameworkHotfixLuaMyStruct(L, 1, gen_to_be_invoked);
        ...
        static int _s_set_e(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Lua.MyStruct gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                IFramework.Hotfix.Lua.Pedding gen_value;translator.Get(L, 2, out gen_value);
