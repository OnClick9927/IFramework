...
{
    public class IFrameworkHotfixLuaLuacICalcBridge : LuaBase, IFramework.Hotfix.Lua.Luac.ICalc
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new IFrameworkHotfixLuaLuacICalcBridge(reference, luaenv);
		}
		
		public IFrameworkHotfixLuaLuacICalcBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
        ...
        int IFramework.Hotfix.Lua.Luac.ICalc.Mult 
        {
		...
		event System.EventHandler<IFramework.Hotfix.Lua.Luac.PropertyChangedEventArgs> IFramework.Hotfix.Lua.Luac.ICalc.PropertyChanged
		{
			add
			{
#if THREAD_SAFE || HOTFIX_ENABLE
        ...
        object IFramework.Hotfix.Lua.Luac.ICalc.this[int index]
		{
		    get
			{
#if THREAD_SAFE || HOTFIX_ENABLE
