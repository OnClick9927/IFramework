...
namespace XLua.CSObjectWrap
{
    ...
    public class IFrameworkHotfixLuaNoGcWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IFramework.Hotfix.Lua.NoGc);
        ...
        static int _s_set_a3(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Lua.NoGc gen_to_be_invoked = (IFramework.Hotfix.Lua.NoGc)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.a3 = (IFramework.Hotfix.Lua.MyStruct[])translator.GetObject(L, 2, typeof(IFramework.Hotfix.Lua.MyStruct[]));
        ...
        static int _s_set_a4(RealStatePtr L)
        {
		    try {
                ...
                IFramework.Hotfix.Lua.NoGc gen_to_be_invoked = (IFramework.Hotfix.Lua.NoGc)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.a4 = (IFramework.Hotfix.Lua.MyEnum[])translator.GetObject(L, 2, typeof(IFramework.Hotfix.Lua.MyEnum[]));
